...
DefaultLabeledImageFile = '/d2/studies/CM2/SmartSPIM/ReichelLab/WHS_SD_RatAnnotations_Cropped.ome.tif';
...
DefaultAnnotationFile   = os.path.join(ClearMapPath, 'Data/Waxholm_SD_rat_atlas_annotationLabels.csv');
...
LabelRecord = collections.namedtuple('LabelRecord', 'id, name, acronym, color, parent, collapse'); #transp, vis, 
